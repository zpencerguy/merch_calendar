...
Gem::Specification.new do |s|
  ...
  s.authors     = ["Stitch Fix Engineering","Lisa Sheridan","Mitch Dempsey","Simeon Willbanks"]
  s.email       = ["opensource@stitchfix.com","owner@codevelvet.com","webdestroya@users.noreply.github.com","simeon@stitchfix.com"]
  s.licenses    = ['MIT']
